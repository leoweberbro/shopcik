...
from tgbot.data.config import get_admins, BOT_TOKEN, BOT_SCHEDULER, CHANNEL_ID
...
colorama.init()
from checksub import SubscriptionMiddleware,TextSubscriptionMiddleware
...
async def main():
    ...
    dp.callback_query.middleware(SubscriptionMiddleware(bot, CHANNEL_ID)) 
    dp.message.middleware(TextSubscriptionMiddleware(bot, CHANNEL_ID)) 
